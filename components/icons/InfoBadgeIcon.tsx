...
interface InfoBadgeIconProps extends IconProps {
  backgroundColor: string;
  color: string;
}

const InfoBadgeIcon: React.FC<InfoBadgeIconProps> = ({ size = 28, backgroundColor, color }) => (
  <Svg width={size} height={size} viewBox="0 0 28 28" fill="none">
    ...
    />
    <Path d="M13.8314 11.7576V14.0628" stroke={color} strokeWidth={1.15258} strokeLinecap="round" strokeLinejoin="round" />
    <Path d="M13.8314 16.368H13.8372" stroke={color} strokeWidth={1.15258} strokeLinecap="round" strokeLinejoin="round" />
  </Svg>
);
